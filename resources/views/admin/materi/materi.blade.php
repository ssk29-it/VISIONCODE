...
<head>
  <meta charset="UTF-8" />
  <title>Materi Edukasi | BK Care SMK Budi Bakti Ciwidey</title>
  ...
  <style>
    * {
    ...
    .materi-card:hover {
      transform: translateY(-5px);
      box-shadow: 0 15px 30px -10px rgba(79, 141, 184, 0.2);
    }
...
<body class="font-sans text-gray-700 overflow-x-hidden">
  ...
  <div id="modalContent" class="modal-content">
    <div class="flex justify-between items-center mb-6">
      <h3 class="text-xl font-bold text-[#17235b]">Tambah Materi Edukasi</h3>
      <button onclick="closeModal()" class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-gray-500 hover:text-gray-700 transition">
    ...
    <form class="space-y-5">
      <!-- Foto Upload -->
      <div>
        <label class="block text-sm font-semibold text-gray-700 mb-2">Foto Materi</label>
        <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-[#4F8DB8] transition cursor-pointer">
          <i class="fa-regular fa-image text-4xl text-gray-400 mb-2"></i>
          <p class="text-sm text-gray-500">Klik atau drag & drop untuk upload gambar</p>
      ...
      <div>
        ...
        <input type="text" placeholder="Masukkan judul materi" class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#4F8DB8] focus:border-transparent" />
      </div>

      <!-- Kategori -->
      <div>
        <label class="block text-sm font-semibold text-gray-700 mb-2">Kategori</label>
        <select class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#4F8DB8] focus:border-transparent">
      ...
      <div>
        ...
        <textarea rows="5" placeholder="Tulis deskripsi materi..." class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#4F8DB8] focus:border-transparent"></textarea>
      </div>

      <!-- Tombol -->
      <div class="flex gap-3 pt-4">
        <button type="button" onclick="closeModal()" class="flex-1 py-3 rounded-xl bg-gray-100 text-gray-700 hover:bg-gray-200 transition font-medium">
          Batal
        </button>
        <button type="submit" class="flex-1 py-3 rounded-xl bg-gradient-to-r from-[#4F8DB8] to-[#6FAED9] text-white hover:shadow-lg transition font-medium">
          Simpan Materi
        </button>
      </div>
    </form>
  ...
  <div id="mobileSidebar" class="sidebar-mobile">
    <div class="h-full w-full glass-card-deep rounded-r-2xl p-5 flex flex-col overflow-y-auto border-r border-white/40 shadow-2xl">
      ...
      <nav class="flex-1 overflow-y-auto py-5 space-y-1 text-sm">
        ...
        <!-- Materi Edukasi - ACTIVE -->
        <a href="crudmateri.html" class="menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-[#4F8DB8]/10 transition-all menu-active">
          <i class="fa-solid fa-book-open w-5 text-center text-white"></i>
          <span class="font-medium text-white">Materi Edukasi</span>
          <span class="ml-auto bg-white text-[#4F8DB8] text-[10px] px-2 py-0.5 rounded-full font-bold">12</span>
        </a>
  ...
  <div class="flex min-h-screen relative">
    ...
    <aside class="hidden lg:block sidebar-desktop z-10">
      <div class="inner-sidebar glass-card-deep rounded-2xl m-4 p-5 w-80 border border-white/40 shadow-2xl">
        ...
        <!-- PROFILE ADMIN - DESKTOP (SIMPLE ELEGANT) -->
    ...
    <!-- ================= MAIN CONTENT - CRUD MATERI EDUKASI ================= -->
    <main class="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6 relative z-10 lg:ml-0">
      ...
      <div class="glass-card-deep rounded-xl md:rounded-2xl p-3 md:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border border-white/40 shadow-xl">
        <div class="flex items-center gap-2 md:gap-3">
          ...
          <div>
            <h2 class="font-extrabold text-[#17235b] text-base md:text-xl">
              <span class="text-gradient">Materi Edukasi</span>
            </h2>
            <p class="text-[10px] md:text-xs text-gray-500 flex items-center gap-1 md:gap-2">
              <i class="fa-regular fa-graduation-cap text-[#4F8DB8]"></i>
              <span>Kelola materi edukasi untuk siswa SMK Budi Bakti Ciwidey</span>
            </p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-2 text-xs text-gray-400 self-end sm:self-auto">
          <span>Admin</span>
          <i class="fa-solid fa-chevron-right text-[10px]"></i>
          <span class="text-[#4F8DB8] font-medium">Materi Edukasi</span>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          <div class="w-10 h-10 bg-[#4F8DB8]/10 rounded-lg flex items-center justify-center">
            <i class="fa-solid fa-book-open text-[#4F8DB8] text-lg"></i>
          </div>
          <div>
        ...
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-[#17235b]">1.247</p>
          </div>
        </div>
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          <div class="w-10 h-10 bg-yellow-500/10 rounded-lg flex items-center justify-center">
            <i class="fa-solid fa-download text-yellow-600 text-lg"></i>
          </div>
          <div>
            <p class="text-xs text-gray-500">Total Download</p>
            <p class="text-xl font-bold text-[#17235b]">856</p>
          </div>
        </div>
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-[#17235b]">4</p>
          </div>
        </div>
      </div>

      <!-- FILTER & SEARCH + BUTTON TAMBAH -->
      <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div class="relative flex-1 w-full">
              ...
              <div class="relative flex items-center gap-2 bg-white rounded-lg px-4 py-2.5 border border-white/50 shadow-sm">
                ...
                <input type="text" placeholder="Cari materi edukasi..." class="w-full outline-none text-sm text-gray-700 placeholder-gray-400 bg-transparent" />
              </div>
            </div>
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
              ...
              <button class="px-4 py-2.5 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm text-gray-700 transition-colors flex items-center gap-2">
        ...
        <!-- BUTTON TAMBAH -->
        <button onclick="openModal()" class="flex items-center gap-2 px-6 py-3.5 bg-gradient-to-r from-[#4F8DB8] to-[#6FAED9] text-white text-sm font-semibold rounded-xl hover:shadow-lg hover:shadow-[#4F8DB8]/30 transition-all duration-300 hover:scale-[1.02] shadow-md whitespace-nowrap">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <!-- MATERI CARD 1 - Akademik -->
        <div class="glass-card-deep rounded-xl overflow-hidden border border-white/40 shadow-md materi-card">
          <div class="h-48 overflow-hidden bg-gradient-to-br from-[#17235b] to-[#2a4a7a] relative">
            <img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=600&auto=format&fit=crop" alt="Materi Akademik" class="w-full h-full object-cover">
          ...
          <div class="p-5">
            <h3 class="font-bold text-[#17235b] text-lg mb-2">Strategi Belajar Efektif</h3>
            <p class="text-sm text-gray-600 mb-4 line-clamp-2">Teknik belajar, manajemen waktu, dan persiapan ujian untuk siswa SMK.</p>
            <div class="flex items-center justify-between text-xs text-gray-500 mb-4">
              <span><i class="fa-regular fa-eye mr-1"></i> 342 dilihat</span>
              <span><i class="fa-regular fa-clock mr-1"></i> 15 Feb 2026</span>
            </div>
            <div class="flex items-center gap-2">
              <button class="flex-1 px-3 py-2 rounded-lg bg-gradient-to-r from-[#4F8DB8] to-[#6FAED9] text-white text-xs font-medium hover:shadow-md transition-all flex items-center justify-center gap-1">
                <i class="fa-regular fa-eye"></i> Detail
              </button>
              <button class="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 transition-all">
                <i class="fa-regular fa-pen-to-square"></i>
              </button>
              <button class="w-8 h-8 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 transition-all">
        ...
        <!-- MATERI CARD 2 - Karir -->
        <div class="glass-card-deep rounded-xl overflow-hidden border border-white/40 shadow-md materi-card">
          <div class="h-48 overflow-hidden bg-gradient-to-br from-[#4F8DB8] to-[#6FAED9] relative">
            <img src="https://images.unsplash.com/photo-1521791136064-7986c2920216?w=600&auto=format&fit=crop" alt="Materi Karir" class="w-full h-full object-cover">
            <div class="absolute top-3 right-3">
              <span class="category-badge category-karir">
          ...
          <div class="p-5">
            <h3 class="font-bold text-[#17235b] text-lg mb-2">Sukses Praktik Kerja Lapangan</h3>
            <p class="text-sm text-gray-600 mb-4 line-clamp-2">Tips memilih tempat PKL, etika di dunia kerja, dan mengatasi stres saat praktik.</p>
            <div class="flex items-center justify-between text-xs text-gray-500 mb-4">
              <span><i class="fa-regular fa-eye mr-1"></i> 256 dilihat</span>
              <span><i class="fa-regular fa-clock mr-1"></i> 14 Feb 2026</span>
            </div>
            <div class="flex items-center gap-2">
              <button class="flex-1 px-3 py-2 rounded-lg bg-gradient-to-r from-[#4F8DB8] to-[#6FAED9] text-white text-xs font-medium hover:shadow-md transition-all flex items-center justify-center gap-1">
                <i class="fa-regular fa-eye"></i> Detail
        ...
        <!-- MATERI CARD 3 - Mental Health -->
        <div class="glass-card-deep rounded-xl overflow-hidden border border-white/40 shadow-md materi-card">
          <div class="h-48 overflow-hidden bg-gradient-to-br from-[#6FAED9] to-[#4F8DB8] relative">
            <img src="https://images.unsplash.com/photo-1499209974431-9dddcece7f88?w=600&auto=format&fit=crop" alt="Materi Mental Health" class="w-full h-full object-cover">
            <div class="absolute top-3 right-3">
              <span class="category-badge category-mental">
          ...
          <div class="p-5">
            <h3 class="font-bold text-[#17235b] text-lg mb-2">Mengelola Stres Akademik</h3>
            <p class="text-sm text-gray-600 mb-4 line-clamp-2">Cara mengelola tekanan tugas, ujian, dan adaptasi di lingkungan sekolah.</p>
            <div class="flex items-center justify-between text-xs text-gray-500 mb-4">
              <span><i class="fa-regular fa-eye mr-1"></i> 189 dilihat</span>
              <span><i class="fa-regular fa-clock mr-1"></i> 13 Feb 2026</span>
            </div>
            <div class="flex items-center gap-2">
              <button class="flex-1 px-3 py-2 rounded-lg bg-gradient-to-r from-[#4F8DB8] to-[#6FAED9] text-white text-xs font-medium hover:shadow-md transition-all flex items-center justify-center gap-1">
                <i class="fa-regular fa-eye"></i> Detail
        ...
        <!-- MATERI CARD 4 - Sosial -->
        <div class="glass-card-deep rounded-xl overflow-hidden border border-white/40 shadow-md materi-card">
          <div class="h-48 overflow-hidden bg-gradient-to-br from-[#17235b] to-[#2a4a7a] relative">
            <img src="https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=600&auto=format&fit=crop" alt="Materi Sosial" class="w-full h-full object-cover">
            <div class="absolute top-3 right-3">
              <span class="category-badge category-sosial">
          ...
          <div class="p-5">
            <h3 class="font-bold text-[#17235b] text-lg mb-2">Keterampilan Sosial & Anti Bullying</h3>
            <p class="text-sm text-gray-600 mb-4 line-clamp-2">Etika pergaulan, membangun relasi sehat, dan mencegah perundungan di sekolah.</p>
            <div class="flex items-center justify-between text-xs text-gray-500 mb-4">
              <span><i class="fa-regular fa-eye mr-1"></i> 412 dilihat</span>
              <span><i class="fa-regular fa-clock mr-1"></i> 12 Feb 2026</span>
            </div>
            <div class="flex items-center gap-2">
              <button class="flex-1 px-3 py-2 rounded-lg bg-gradient-to-r from-[#4F8DB8] to-[#6FAED9] text-white text-xs font-medium hover:shadow-md transition-all flex items-center justify-center gap-1">
                <i class="fa-regular fa-eye"></i> Detail
        ...
        <!-- MATERI CARD 5 - Akademik -->
        <div class="glass-card-deep rounded-xl overflow-hidden border border-white/40 shadow-md materi-card">
          <div class="h-48 overflow-hidden bg-gradient-to-br from-[#4F8DB8] to-[#6FAED9] relative">
            <img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&auto=format&fit=crop" alt="Materi Akademik" class="w-full h-full object-cover">
            <div class="absolute top-3 right-3">
              <span class="category-badge category-akademik">
                <i class="fa-solid fa-graduation-cap text-[10px]"></i>
                Akademik
          ...
          <div class="p-5">
            <h3 class="font-bold text-[#17235b] text-lg mb-2">Tips Menghadapi Ujian</h3>
            <p class="text-sm text-gray-600 mb-4 line-clamp-2">Persiapan mental dan akademik menghadapi ujian sekolah dan nasional.</p>
            <div class="flex items-center justify-between text-xs text-gray-500 mb-4">
              <span><i class="fa-regular fa-eye mr-1"></i> 287 dilihat</span>
              <span><i class="fa-regular fa-clock mr-1"></i> 11 Feb 2026</span>
            </div>
            <div class="flex items-center gap-2">
              <button class="flex-1 px-3 py-2 rounded-lg bg-gradient-to-r from-[#4F8DB8] to-[#6FAED9] text-white text-xs font-medium hover:shadow-md transition-all flex items-center justify-center gap-1">
                <i class="fa-regular fa-eye"></i> Detail
        ...
        <div class="glass-card-deep rounded-xl overflow-hidden border border-white/40 shadow-md materi-card">
          <div class="h-48 overflow-hidden bg-gradient-to-br from-[#17235b] to-[#2a4a7a] relative">
            <img src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=600&auto=format&fit=crop" alt="Materi Karir" class="w-full h-full object-cover">
            <div class="absolute top-3 right-3">
              <span class="category-badge category-karir">
                <i class="fa-solid fa-briefcase text-[10px]"></i>
                Karir
          ...
          <div class="p-5">
            <h3 class="font-bold text-[#17235b] text-lg mb-2">Pilihan Karir Setelah SMK</h3>
            <p class="text-sm text-gray-600 mb-4 line-clamp-2">Kuliah, kerja, atau wirausaha? Kenali potensi diri dan peluang masa depan.</p>
            <div class="flex items-center justify-between text-xs text-gray-500 mb-4">
              <span><i class="fa-regular fa-eye mr-1"></i> 198 dilihat</span>
              <span><i class="fa-regular fa-clock mr-1"></i> 10 Feb 2026</span>
            </div>
            <div class="flex items-center gap-2">
              <button class="flex-1 px-3 py-2 rounded-lg bg-gradient-to-r from-[#4F8DB8] to-[#6FAED9] text-white text-xs font-medium hover:shadow-md transition-all flex items-center justify-center gap-1">
                <i class="fa-regular fa-eye"></i> Detail
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 pt-4 border-t border-[#4F8DB8]/20">
        ...
        <div class="text-sm text-gray-500">
          Menampilkan <span class="font-medium text-[#4F8DB8]">1-6</span> dari <span class="font-medium text-[#4F8DB8]">12</span> data
        </div>
