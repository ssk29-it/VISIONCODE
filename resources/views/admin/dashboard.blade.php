...
<head>
  <meta charset="UTF-8" />
  <title>Dashboard Admin | BK Care SMK Budi Bakti Ciwidey</title>
  <meta
    name="viewport"
...
<body class="font-sans text-gray-700 overflow-x-hidden">
        ...
        <div class="flex flex-col items-center mb-5 md:mb-6">
          <div class="relative group">
            ...
            >
              ...
              >
                <img
                  src="https://ui-avatars.com/api/?name=Admin+BK&background=17235b&color=fff&size=120&bold=true"
                  alt="Admin"
          ...
          <p class="text-xs md:text-sm text-gray-500 flex items-center gap-2">
            <i class="fa-solid fa-shield-hart text-[#4F8DB8]"></i>
            Super Administrator
          </p>
          <span
        ...
        >
          ...
          <div class="flex justify-between items-center">
            <div class="text-center">
              <p class="text-lg md:text-2xl font-bold text-[#17235b]">128</p>
              <p class="text-[10px] md:text-xs text-gray-500">Konseling</p>
            </div>
            <div class="w-px h-8 md:h-10 bg-gray-200"></div>
            <div class="text-center">
              <p class="text-lg md:text-2xl font-bold text-[#17235b]">76</p>
              <p class="text-[10px] md:text-xs text-gray-500">Tindak Lanjut</p>
            </div>
            <div class="w-px h-8 md:h-10 bg-gray-200"></div>
            <div class="text-center">
              <p class="text-lg md:text-2xl font-bold text-[#17235b]">42</p>
              <p class="text-[10px] md:text-xs text-gray-500">Pelanggaran</p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-1">
          ...
          <div id="dataMasterMobile" class="ml-6 mt-1 space-y-1 hidden">
            <a
              ...
              class="menu-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-600 hover:bg-[#4F8DB8]/10 transition-all pl-9"
            >
              <i class="fa-solid fa-user-tie text-xs text-[#4F8DB8]"></i>
            ...
            <a
              ...
              class="menu-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-600 hover:bg-[#4F8DB8]/10 transition-all pl-9"
            >
              <i class="fa-solid fa-chalkboard-user text-xs text-[#4F8DB8]"></i>
            ...
            <a
              ...
              class="menu-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-600 hover:bg-[#4F8DB8]/10 transition-all pl-9"
            >
              <i class="fa-solid fa-user-graduate text-xs text-[#4F8DB8]"></i>
        ...
        <div class="space-y-1">
          ...
          <div id="konselingMobile" class="ml-6 mt-1 space-y-1 hidden">
            ...
            <a
              ...
              class="menu-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-600 hover:bg-[#4F8DB8]/10 transition-all pl-9"
            >
              <i class="fa-solid fa-clock-rotate-left text-xs text-[#4F8DB8]"></i>
  ...
  <div class="flex min-h-screen relative">
    ...
    <!-- ================= SIDEBAR DESKTOP - FIXED RESPONSIF ================= -->
    ...
    >
      ...
      >
        ...
        <div class="flex items-center gap-2 md:gap-3 self-end sm:self-auto">
          ...
          <div class="relative group">
            <button
              class="w-9 h-9 md:w-10 md:h-10 bg-white/80 backdrop-blur-sm rounded-xl border border-white/50 hover:bg-[#4F8DB8] hover:text-white transition-all flex items-center justify-center"
            >
              <i class="fa-solid fa-plus text-[#17235b] group-hover:text-white"></i>
            </button>
          </div>
        </div>
      </div>
          ...
          <div class="relative z-10 text-center sm:text-left">
            ...
            <p class="text-xs md:text-sm text-gray-600 max-w-md">
              <span class="hidden sm:inline"
                >Selamat datang kembali di dashboard BK Care
              </span>
          ...
          >
            <div class="flex flex-col items-center group min-w-[50px]">
              ...
              <span
                ...
                >Akademik</span
              >
              <span class="text-[8px] md:text-[10px] text-gray-500">45</span>
            </div>
            ...
            <div class="flex flex-col items-center group min-w-[50px]">
              ...
              <span
                ...
                >Pribadi</span
              >
              <span class="text-[8px] md:text-[10px] text-gray-500">32</span>
            </div>
            ...
            <div class="flex flex-col items-center group min-w-[50px]">
              ...
              <span
                ...
                >Sosial</span
              >
              <span class="text-[8px] md:text-[10px] text-gray-500">28</span>
            </div>
            ...
            <div class="flex flex-col items-center group min-w-[50px]">
              ...
              <span
                ...
                >Karir</span
              >
              <span class="text-[8px] md:text-[10px] text-gray-500">23</span>
            </div>
          </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
        ...
        >
          <div
            class="absolute inset-0 bg-gradient-to-r from-red-500/0 via-red-500/5 to-red-500/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"
          ></div>
          <div
            class="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-red-500 to-orange-500 rounded-xl flex items-center justify-center text-white text-xl md:text-2xl shadow-lg flex-shrink-0"
          >
          ...
          <div class="min-w-0">
            ...
            <div class="flex items-baseline gap-1 md:gap-2">
              ...
              <span
                class="text-[9px] md:text-xs text-red-600 bg-red-100 px-1.5 md:px-2 py-0.5 rounded-full"
                >-8%</span
              >
            </div>
            <p class="text-[9px] md:text-xs text-gray-400 mt-0.5 truncate">
      ...
      <div class="grid lg:grid-cols-2 gap-4 md:gap-6 items-stretch">
        <!-- TABLE DATA KONSELING - RESPONSIVE -->
        <div
        ...
        >
          <div class="flex items-center justify-between mb-3 md:mb-5">
            ...
            >
              ...
              <span class="hidden xs:inline">Data Konseling Terbaru</span>
            ...
            <table class="w-full text-xs md:text-sm min-w-[600px]">
              <thead>
                ...
                >
                  ...
                  <th class="py-2 md:py-3 text-left font-semibold">Tanggal</th>
              ...
              <tbody class="divide-y divide-[#4F8DB8]/10">
                <tr class="hover:bg-[#4F8DB8]/5 transition-colors cursor-pointer">
                  ...
                  <td class="text-[11px] md:text-sm">12/02/26</td>
                  <td>
                    <span
                ...
                <tr class="hover:bg-[#4F8DB8]/5 transition-colors cursor-pointer">
                  ...
                  <td class="text-[11px] md:text-sm">11/02/26</td>
                  <td>
                    <span
                ...
                <tr class="hover:bg-[#4F8DB8]/5 transition-colors cursor-pointer">
                  ...
                  <td class="text-[11px] md:text-sm">10/02/26</td>
                  <td>
                    <span
                ...
                <tr class="hover:bg-[#4F8DB8]/5 transition-colors cursor-pointer">
                  ...
                  <td class="text-[11px] md:text-sm">18/02/26</td>
                  <td>
                    <span
                      class="px-1.5 md:px-3 py-0.5 md:py-1 text-[9px] md:text-xs rounded-full badge-completed font-semibold flex items-center gap-1 w-fit"
                    >
          ...
          >
            ...
            >
              ...
              <span class="hidden xs:inline">Menampilkan</span> 3 dari 24
            </span>
        ...
        >
          <div class="flex items-center justify-between mb-3 md:mb-5">
            ...
            >
              ...
              <span class="hidden xs:inline">Jadwal Konseling</span>
            ...
            <div class="flex gap-2 md:gap-4 group">
              ...
              >
                ...
                <div
                  class="mt-1 md:mt-2 flex items-center gap-2 md:gap-3 text-[8px] md:text-[10px] text-gray-400"
                >
                  <i class="fa-regular fa-user"></i> Pak Ahmad
            ...
            <div class="flex gap-2 md:gap-4 group">
              ...
              >
                ...
                <div
                  class="mt-1 md:mt-2 flex items-center gap-2 md:gap-3 text-[8px] md:text-[10px] text-gray-400"
                >
                  <i class="fa-regular fa-user"></i> Bu Rina
                  <i
          ...
          <div class="mt-3 md:mt-4 pt-3 md:pt-4 border-t border-[#4F8DB8]/20">
            <a
              href="#"
              class="text-[9px] md:text-xs text-[#4F8DB8] hover:text-[#17235b] font-semibold flex items-center justify-center gap-1 md:gap-2 transition-all w-full py-1.5 md:py-2 group"
            >
              <i
                class="fa-regular fa-calendar-plus group-hover:scale-110 transition-transform"
              ></i>
              <span class="hidden xs:inline">Atur Jadwal Baru</span>
              <span class="xs:hidden">Tambah Jadwal</span>
            </a>
          </div>
        </div>
      </div>

      <!-- ================= FOOTER ADMIN - RESPONSIVE ================= -->
      <div
...
<div id="successPopup"
    ...
    <div class="bg-white w-[90%] max-w-sm rounded-2xl shadow-2xl p-6 text-center animate-fadeIn">
        
        <div class="w-14 h-14 mx-auto flex items-center justify-center rounded-full bg-green-100 mb-4">
...
@endif
  ...
  <!-- MODAL LOGOUT -->
<div id="logoutModal" class="fixed inset-0 hidden items-center justify-center bg-black/50 z-50">
    <div class="bg-white w-[90%] max-w-sm rounded-2xl shadow-2xl p-6 text-center animate-fadeIn">
        
        <div class="mb-4">
            <div class="w-14 h-14 mx-auto flex items-center justify-center rounded-full bg-red-100">
                <i class="fa-solid fa-right-from-bracket text-red-500 text-xl"></i>
            </div>
        </div>

        <h2 class="text-lg font-bold text-gray-800">Konfirmasi Logout</h2>
        ...
        <div class="flex gap-3 mt-6">
            <button id="cancelLogout"
                class="w-1/2 py-2 rounded-xl bg-gray-100 text-gray-600 hover:bg-gray-200 transition">
                Batal
            </button>

            <button id="confirmLogout"
                class="w-1/2 py-2 rounded-xl bg-red-500 text-white hover:bg-red-600 transition">
                Ya, Logout
            </button>
        </div>
