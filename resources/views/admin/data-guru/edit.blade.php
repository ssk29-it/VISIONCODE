...
<html lang="id">
  <head>
    <meta charset="UTF-8" />
    <title>Edit Guru BK | BK Care SMK Budi Bakti Ciwidey</title>
    <meta
      name="viewport"
      ...
      <main class="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6 relative z-10">
        ...
        <div class="glass-card-deep rounded-xl md:rounded-2xl p-3 md:p-5 flex flex-wrap items-center justify-between gap-3 border border-white/40 shadow-xl">
          <div class="flex items-center gap-2 md:gap-3">
            ...
            <div>
              <h2 class="font-extrabold text-[#17235b] text-base md:text-xl">
                <span class="text-gradient">Edit Guru BK</span>
              </h2>
          ...
          <div class="flex items-center gap-2 text-xs text-gray-400 self-end sm:self-auto">
            ...
            <i class="fa-solid fa-chevron-right text-[10px]"></i>
            <span class="text-[#4F8DB8] font-medium">Edit Guru BK</span>
          </div>
        </div>

       {{-- FORM INPUT --}}
      <form action="{{ route('data-guru.update', $gurubk->id) }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PUT')
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <div class="md:col-span-2">
                  ...
                  <div class="relative">
                    ...
                    <input
                        ...
                        name="nama_gurubk"
                        required
                        value="{{ old('nama_gurubk', $gurubk->nama_gurubk) }}"
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <input
                      ...
                      required
                      name="tempat_lahir"
                      value="{{ old('tempat_lahir', $gurubk->tempat_lahir) }}"
                      class="relative w-full h-10 px-4 rounded-lg border border-gray-200 bg-white/90 focus:outline-none focus:ring-2 focus:ring-[#4F8DB8] focus:border-transparent transition-all text-sm placeholder:text-gray-400"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <input
                      ...
                      required
                      name="tanggal_lahir"
                      value="{{ old('tanggal_lahir', $gurubk->tanggal_lahir) }}"
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <input
                      ...
                      required
                      value="{{ old('pendidikan_terakhir', $gurubk->pendidikan_terakhir) }}"
                      class="relative w-full h-10 px-4 rounded-lg border border-gray-200 bg-white/90 focus:outline-none focus:ring-2 focus:ring-[#4F8DB8] focus:border-transparent transition-all text-sm placeholder:text-gray-400"
                    />
                  </div>
                ...
                <div class="md:col-span-2">
                  ...
                  <div class="relative">
                    ...
                    >{{ old('alamat', $gurubk->alamat) }}</textarea>
                  </div>
                </div>
              </div>
            </div>
