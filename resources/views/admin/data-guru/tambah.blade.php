...
<html lang="id">
  <head>
    <meta charset="UTF-8" />
    <title>Tambah Guru BK | BK Care SMK Budi Bakti Ciwidey</title>
    <meta
      name="viewport"
      ...
      <main class="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6 relative z-10">
        ...
        <div class="glass-card-deep rounded-xl md:rounded-2xl p-3 md:p-5 flex flex-wrap items-center justify-between gap-3 border border-white/40 shadow-xl">
          <div class="flex items-center gap-2 md:gap-3">
            ...
            <div>
              <h2 class="font-extrabold text-[#17235b] text-base md:text-xl">
                <span class="text-gradient">Tambah Guru BK</span>
              </h2>
              <p class="text-[10px] md:text-xs text-gray-500 flex items-center gap-1 md:gap-2">
                ...
                <span>Form input data guru BK lengkap</span>
              </p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-2 text-xs text-gray-400 self-end sm:self-auto">
            ...
            <i class="fa-solid fa-chevron-right text-[10px]"></i>
            <span class="text-[#4F8DB8] font-medium">Tambah Guru BK</span>
          </div>
        </div>
      ...
      <form action="{{ route('data-guru.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="glass-card-deep rounded-xl md:rounded-2xl p-4 md:p-6 border border-white/40 shadow-xl max-w-4xl mx-auto">
          ...
          <div class="flex items-center gap-3 mb-6 pb-4 border-b border-[#4F8DB8]/20">
            ...
            <div>
              <h3 class="font-bold text-[#17235b]">Form Biodata Guru BK</h3>
          ...
          <div class="flex flex-col lg:flex-row gap-6 lg:gap-8">
            ...
            <div class="w-full lg:w-64 flex-shrink-0">
              ...
              <div class="relative group">
                ...
                <div class="relative w-full aspect-square bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl overflow-hidden border-2 border-white shadow-lg flex flex-col items-center justify-center text-gray-400">
                  <!-- Preview Image (akan muncul setelah pilih file) -->
                  <img id="previewFoto" src="#" alt="Preview Foto" class="w-full h-full object-cover hidden" />
                  <div id="placeholderPreview" class="flex flex-col items-center justify-center w-full h-full">
                    <i class="fa-solid fa-image text-4xl mb-2 opacity-40"></i>
            ...
            <div class="flex-1">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <!-- Pendidikan Terakhir (field baru) -->
                <div>
                  <label class="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-2">
                    <i class="fa-regular fa-graduation-cap text-[#4F8DB8] mr-1"></i> Pendidikan Terakhir <span class="text-red-500">*</span>
                  </label>
                  <div class="relative">
                    <div class="absolute inset-0 bg-gradient-to-r from-[#4F8DB8] to-[#6FAED9] rounded-lg blur opacity-10"></div>
                    <input
          ...
          <div class="mt-8 pt-6 border-t border-[#4F8DB8]/20 flex flex-col sm:flex-row gap-3 sm:gap-4">
            <a href="{{ route('data-guru.index') }}" class="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 text-sm font-medium">
        ...
        if (inputFoto) {
          inputFoto.addEventListener('change', function(event) {
            ...
            if (file) {
              ...
              // Jika tidak ada file, kembali ke placeholder
              previewFoto.src = '#';
