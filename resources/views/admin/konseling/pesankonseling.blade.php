...
<head>
  <meta charset="UTF-8" />
  <title>Pesan Konseling | BK Care SMK Budi Bakti Ciwidey</title>
  ...
  <style>
    * {
    ...
    .message-card:hover {
      border-color: #4F8DB8;
      box-shadow: 0 10px 25px -5px rgba(79, 141, 184, 0.1);
    }
    ...
    .category-badge {
      background: rgba(79, 141, 184, 0.1);
      color: #4F8DB8;
      border: 1px solid rgba(79, 141, 184, 0.2);
    }
...
<body class="font-sans text-gray-700 overflow-x-hidden">
  ...
  <div id="mobileSidebar" class="sidebar-mobile">
    <div class="h-full w-full glass-card-deep rounded-r-2xl p-5 flex flex-col overflow-y-auto border-r border-white/40 shadow-2xl">
      ...
      <nav class="flex-1 overflow-y-auto py-5 space-y-1 text-sm">
        <a href="dashboard.html" class="menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-[#4F8DB8]/10 transition-all">
        ...
        <div class="space-y-1">
          ...
          <div id="dataMasterMobile" class="ml-6 mt-1 space-y-1 hidden">
            <a href="data-guru-bk.html" class="submenu-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-600 hover:bg-[#4F8DB8]/10 transition-all pl-9">
            ...
            <a href="data-wali-kelas.html" class="submenu-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-600 hover:bg-[#4F8DB8]/10 transition-all pl-9">
              <span class="w-1 h-1 bg-gray-300 rounded-full"></span>
            ...
            <a href="data-siswa.html" class="submenu-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-600 hover:bg-[#4F8DB8]/10 transition-all pl-9">
              <span class="w-1 h-1 bg-gray-300 rounded-full"></span>
        ...
        <div class="space-y-1">
          <button onclick="toggleMobileMenu('konselingMobile')" 
            ...
            <i class="fas fa-chevron-down text-xs text-white transition-transform duration-300" id="chevron-konselingMobile"></i>
          </button>
          <div id="konselingMobile" class="ml-6 mt-1 space-y-1">
            <a href="pengajuan-konseling.html" class="submenu-item flex items-center gap-3 px-4 py-2.5 rounded-xl bg-[#4F8DB8]/10 text-[#4F8DB8] font-medium pl-9">
            ...
            <a href="jadwal-konseling.html" class="submenu-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-600 hover:bg-[#4F8DB8]/10 transition-all pl-9">
              <span class="w-1 h-1 bg-gray-300 rounded-full"></span>
              <span class="text-sm">Jadwal Konseling</span>
            </a>
            <a href="riwayat-konseling.html" class="submenu-item flex items-center gap-3 px-4 py-2.5 rounded-xl text-gray-600 hover:bg-[#4F8DB8]/10 transition-all pl-9">
              <span class="w-1 h-1 bg-gray-300 rounded-full"></span>
        ...
        <a href="materi-edukasi.html" class="menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-[#4F8DB8]/10 transition-all">
          <i class="fa-solid fa-book-open w-5 text-center text-[#4F8DB8]"></i>
          <span class="font-medium">Materi Edukasi</span>
        </a>

        <a href="laporan-konseling.html" class="menu-item flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-[#4F8DB8]/10 transition-all">
  ...
  <div class="flex min-h-screen relative">
    ...
    <!-- ================= SIDEBAR DESKTOP - SAMA PERSIS DENGAN DASHBOARD ================= -->
        ...
        <nav class="flex-1 overflow-y-auto py-5 space-y-1 text-sm">
          ...
          <div class="space-y-1">
            <button onclick="toggleMenu('konseling')" 
              ...
              <i class="fas fa-chevron-down text-xs text-white transition-transform duration-300" id="chevron-konseling"></i>
            </button>
            <div id="konseling" class="ml-6 mt-1 space-y-1">
              <a href="pesankonseling.html" class="submenu-item flex items-center gap-3 px-4 py-2.5 rounded-xl bg-[#4F8DB8]/10 text-[#4F8DB8] font-medium pl-9">
                <span class="w-1 h-1 bg-[#4F8DB8] rounded-full"></span>
                <span class="text-sm">Pengajuan Konseling</span>
                <span class="ml-auto bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-full">3</span>
              </a>
    ...
    <main class="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6 relative z-10 lg:ml-0">
      ...
      <div class="glass-card-deep rounded-xl md:rounded-2xl p-3 md:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border border-white/40 shadow-xl">
        ...
        <div class="flex items-center gap-2 text-xs text-gray-400 self-end sm:self-auto">
          <span>Admin</span>
          <i class="fa-solid fa-chevron-right text-[10px]"></i>
          <span>Sistem Konseling</span>
          <i class="fa-solid fa-chevron-right text-[10px]"></i>
          <span class="text-[#4F8DB8] font-medium">Pengajuan Konseling</span>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          <div class="w-10 h-10 bg-[#4F8DB8]/10 rounded-lg flex items-center justify-center">
            <i class="fa-solid fa-envelope text-[#4F8DB8] text-lg"></i>
          </div>
          <div>
            <p class="text-xs text-gray-500">Total Pesan</p>
            <p class="text-xl font-bold text-[#17235b]">24</p>
          </div>
        </div>
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          ...
          <div>
            <p class="text-xs text-gray-500">Pengajuan Baru</p>
            <p class="text-xl font-bold text-[#17235b]">5</p>
          </div>
        </div>
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
        ...
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          <div class="w-10 h-10 bg-blue-500/10 rounded-lg flex items-center justify-center">
            <i class="fa-solid fa-check-double text-blue-600 text-lg"></i>
          </div>
          <div>
            <p class="text-xs text-gray-500">Selesai</p>
            <p class="text-xl font-bold text-[#17235b]">7</p>
          </div>
        </div>
      </div>
        ...
        <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <div class="relative flex-1 w-full">
            ...
            <div class="relative flex items-center gap-2 bg-white rounded-lg px-4 py-2.5 border border-white/50 shadow-sm">
              ...
              <input
                type="text"
                placeholder="Cari pesan dari siswa..."
          ...
          <div class="flex items-center gap-3 w-full md:w-auto">
            <button class="px-4 py-2.5 rounded-lg border border-gray-200 bg-white text-sm text-gray-600 hover:bg-gray-50 transition-all flex items-center gap-2 shadow-sm">
              <i class="fa-solid fa-filter text-xs"></i>
              Semua Pesan
            </button>

            <button class="px-4 py-2.5 rounded-lg bg-gradient-to-r from-yellow-400 to-yellow-500 text-sm font-medium text-white shadow-md hover:shadow-lg transition-all hover:scale-[1.02] flex items-center gap-2">
      ...
      <div class="space-y-4">
        ...
        <!-- CARD ITEM 1 - Pribadi -->
        <div class="glass-card-deep rounded-xl p-5 border border-white/40 shadow-md message-card flex flex-col md:flex-row md:items-start justify-between gap-4 hover:border-[#4F8DB8] transition-all">
          
          <!-- KIRI - INFO SISWA -->
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-2">
              <div class="w-10 h-10 bg-gradient-to-br from-[#4F8DB8]/20 to-[#6FAED9]/20 rounded-full flex items-center justify-center text-[#4F8DB8]">
                <i class="fa-solid fa-user-graduate"></i>
              </div>
              <div>
                <div class="flex items-center gap-2">
                  <h3 class="font-bold text-gray-800">Siska O.S</h3>
                  <span class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-full">XII RPL 2</span>
                </div>
                <p class="text-xs text-gray-400 flex items-center gap-1 mt-0.5">
                  <i class="fa-regular fa-clock"></i> 10 menit yang lalu
                </p>
              </div>
            </div>
            
            <p class="text-sm text-gray-600 mt-2 leading-relaxed">
              "Saya mengalami masalah pribadi yang sedang mengganggu pikiran saya. 
              Saya merasa cemas dan sulit berkonsentrasi saat belajar."
            </p>
            
            <div class="flex flex-wrap items-center gap-2 mt-3">
              <span class="px-3 py-1.5 text-xs rounded-full bg-yellow-100 text-yellow-700 font-medium flex items-center gap-1">
                <i class="fa-regular fa-face-frown"></i>
                Masalah Pribadi
              </span>
              <span class="px-3 py-1.5 text-xs rounded-full bg-blue-100 text-blue-700 font-medium flex items-center gap-1">
          ...
          <div class="flex flex-row md:flex-col gap-2 md:gap-3 md:w-48 message-actions">
            <button class="flex-1 md:w-full px-4 py-2.5 text-sm rounded-lg bg-gradient-to-r from-[#4F8DB8] to-[#6FAED9] text-white hover:shadow-lg hover:shadow-[#4F8DB8]/30 transition-all duration-300 hover:scale-[1.02] font-medium flex items-center justify-center gap-2">
              <i class="fa-regular fa-eye"></i>
              Detail
            </button>
            <button class="flex-1 md:w-full px-4 py-2.5 text-sm rounded-lg bg-white border border-red-500 text-red-500 hover:bg-red-50 hover:border-red-600 transition-all duration-200 font-medium flex items-center justify-center gap-2">
        ...
        <div class="glass-card-deep rounded-xl p-5 border border-white/40 shadow-md message-card flex flex-col md:flex-row md:items-start justify-between gap-4 hover:border-[#4F8DB8] transition-all">
          ...
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-2">
              ...
              <div>
                <div class="flex items-center gap-2">
                  <h3 class="font-bold text-gray-800">Muthy Chairunnisa</h3>
                  <span class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-full">XII RPL 2</span>
                </div>
                <p class="text-xs text-gray-400 flex items-center gap-1 mt-0.5">
                  <i class="fa-regular fa-clock"></i> 15 menit yang lalu
                </p>
              </div>
            </div>
            
            <p class="text-sm text-gray-600 mt-2 leading-relaxed">
              "Saya mengalami masalah sosial dengan teman sekelas. 
              Ada kesalahpahaman yang membuat suasana kelas tidak nyaman."
            </p>
            
            <div class="flex flex-wrap items-center gap-2 mt-3">
              <span class="px-3 py-1.5 text-xs rounded-full bg-blue-100 text-blue-700 font-medium flex items-center gap-1">
                <i class="fa-regular fa-people-robbery"></i>
                Masalah Sosial
              </span>
              <span class="px-3 py-1.5 text-xs rounded-full bg-yellow-100 text-yellow-700 font-medium flex items-center gap-1">
        ...
        <div class="glass-card-deep rounded-xl p-5 border border-white/40 shadow-md message-card flex flex-col md:flex-row md:items-start justify-between gap-4 hover:border-[#4F8DB8] transition-all">
          ...
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-2">
              ...
              <div>
                <div class="flex items-center gap-2">
                  <h3 class="font-bold text-gray-800">Revan Nurfalah</h3>
                  <span class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-full">XII RPL 2</span>
                </div>
                <p class="text-xs text-gray-400 flex items-center gap-1 mt-0.5">
                  <i class="fa-regular fa-clock"></i> 20 menit yang lalu
                </p>
              </div>
            </div>
            
            <p class="text-sm text-gray-600 mt-2 leading-relaxed">
              "Saya mengalami masalah karier. Saya bingung memilih antara kuliah 
              atau bekerja setelah lulus SMK. Mohon bimbingannya."
            </p>
            
            <div class="flex flex-wrap items-center gap-2 mt-3">
              <span class="px-3 py-1.5 text-xs rounded-full bg-purple-100 text-purple-700 font-medium flex items-center gap-1">
                <i class="fa-regular fa-briefcase"></i>
                Masalah Karir
              </span>
              <span class="px-3 py-1.5 text-xs rounded-full bg-green-100 text-green-700 font-medium flex items-center gap-1">
        ...
        <div class="glass-card-deep rounded-xl p-5 border border-white/40 shadow-md message-card flex flex-col md:flex-row md:items-start justify-between gap-4 hover:border-[#4F8DB8] transition-all">
          ...
          <div class="flex-1">
            <div class="flex items-center gap-3 mb-2">
              ...
              <div>
                <div class="flex items-center gap-2">
                  <h3 class="font-bold text-gray-800">Anisa Putri</h3>
                  <span class="text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded-full">XI AKL 1</span>
                </div>
                <p class="text-xs text-gray-400 flex items-center gap-1 mt-0.5">
                  <i class="fa-regular fa-clock"></i> 35 menit yang lalu
                </p>
              </div>
            </div>
            
            <p class="text-sm text-gray-600 mt-2 leading-relaxed">
              "Saya kesulitan memahami materi akuntansi. Nilai saya turun drastis 
              dan saya takut tidak naik kelas. Mohon saran belajar yang efektif."
            </p>
            
            <div class="flex flex-wrap items-center gap-2 mt-3">
              <span class="px-3 py-1.5 text-xs rounded-full bg-emerald-100 text-emerald-700 font-medium flex items-center gap-1">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 pt-4 border-t border-[#4F8DB8]/20">
        <div class="text-sm text-gray-500">
          Menampilkan <span class="font-medium text-[#4F8DB8]">1-4</span> dari <span class="font-medium text-[#4F8DB8]">24</span> pesan
        </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <button class="w-8 h-8 rounded-lg bg-white border border-gray-200 hover:bg-[#4F8DB8] hover:text-white hover:border-[#4F8DB8] transition-all flex items-center justify-center text-gray-700">6</button>
          <button class="w-8 h-8 rounded-lg bg-white border border-gray-200 hover:bg-[#4F8DB8] hover:text-white hover:border-[#4F8DB8] transition-all flex items-center justify-center text-gray-500">
            <i class="fa-solid fa-chevron-right text-xs"></i>
          </button>
        </div>
  ...
  <script>
    ...
    // AUTO EXPAND SISTEM KONSELING SUBMENU (karena halaman Pengajuan Konseling)
    document.addEventListener("DOMContentLoaded", function() {
      // Untuk desktop
      const konselingMenu = document.getElementById('konseling');
      const konselingChevron = document.getElementById('chevron-konseling');
      if (konselingMenu && konselingChevron) {
        konselingMenu.classList.remove('hidden');
        konselingChevron.style.transform = 'rotate(180deg)';
      }

      // Untuk mobile
      const konselingMobile = document.getElementById('konselingMobile');
      const konselingChevronMobile = document.getElementById('chevron-konselingMobile');
      if (konselingMobile && konselingChevronMobile) {
        konselingMobile.classList.remove('hidden');
        konselingChevronMobile.style.transform = 'rotate(180deg)';
      }
    });
  </script>
