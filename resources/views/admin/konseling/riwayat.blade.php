...
<head>
  <meta charset="UTF-8" />
  <title>Riwayat Konseling | BK Care SMK Budi Bakti Ciwidey</title>
...
<body class="font-sans text-gray-700 overflow-x-hidden">
  ...
  <div id="mobileSidebar" class="sidebar-mobile">
    <div class="h-full w-full glass-card-deep rounded-r-2xl p-5 flex flex-col overflow-y-auto border-r border-white/40 shadow-2xl">
      ...
      <!-- MENU NAVIGASI MOBILE - SAMA PERSIS -->
      <nav class="flex-1 overflow-y-auto py-5 space-y-1 text-sm">
        ...
        <div class="space-y-1">
          ...
          <div id="konselingMobile" class="ml-6 mt-1 space-y-1">
            ...
            <a href="riwayat.html" class="submenu-item flex items-center gap-3 px-4 py-2.5 rounded-xl bg-[#4F8DB8]/10 text-[#4F8DB8] font-medium pl-9">
  ...
  <div class="flex min-h-screen relative">
    ...
    <!-- ================= MAIN CONTENT - RIWAYAT KONSELING ================= -->
    <main class="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6 relative z-10 lg:ml-0">
      ...
      <div class="glass-card-deep rounded-xl md:rounded-2xl p-3 md:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border border-white/40 shadow-xl">
        <div class="flex items-center gap-2 md:gap-3">
          ...
          <div>
            ...
            <p class="text-[10px] md:text-xs text-gray-500 flex items-center gap-1 md:gap-2">
              ...
              <span>Riwayat Konseling SMK Budi Bakti Ciwidey</span>
            </p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-2 text-xs text-gray-400 self-end sm:self-auto">
          ...
          <i class="fa-solid fa-chevron-right text-[10px]"></i>
          <span class="text-[#4F8DB8] font-medium">Riwayat Konseling</span>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          <div class="w-10 h-10 bg-[#4F8DB8]/10 rounded-lg flex items-center justify-center">
            <i class="fa-solid fa-clock-rotate-left text-[#4F8DB8] text-lg"></i>
          </div>
          <div>
            <p class="text-xs text-gray-500">Total Riwayat</p>
            <p class="text-xl font-bold text-[#17235b]">156</p>
          </div>
        </div>
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-[#17235b]">128</p>
          </div>
        </div>
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-[#17235b]">18</p>
          </div>
        </div>
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-[#17235b]">10</p>
          </div>
        </div>
      </div>
        ...
        <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <div class="relative flex-1 w-full">
            ...
            <div class="relative flex items-center gap-2 bg-white rounded-lg px-4 py-2.5 border border-white/50 shadow-sm">
              ...
              <input type="text" placeholder="Cari riwayat konseling..." class="w-full outline-none text-sm text-gray-700 placeholder-gray-400 bg-transparent" />
            </div>
          </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <h3 class="font-bold text-[#17235b] text-lg">Februari 2026</h3>
          <span class="text-xs bg-[#4F8DB8]/10 text-[#4F8DB8] px-3 py-1.5 rounded-full font-medium">12 Riwayat</span>
        </div>

        <!-- RIWAYAT CARD 1 -->
        <div class="glass-card-deep rounded-xl p-5 border border-white/40 shadow-md history-card">
          <div class="flex flex-col lg:flex-row lg:items-center gap-4">
            
            <!-- DATE -->
            <div class="flex items-center gap-3 lg:w-32">
              <div class="w-10 h-10 bg-gradient-to-br from-[#4F8DB8] to-[#6FAED9] rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-md">
                12
              </div>
              <div>
                <span class="font-bold text-gray-800 text-sm">Feb 2026</span>
              ...
              <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div>
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                    ...
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-calendar text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Tgl Selesai: <span class="font-medium text-gray-800">12 Feb 2026</span></span>
                    </div>
                  </div>
                </div>
                <div class="flex items-center gap-2">
                  ...
                  <button class="px-4 py-2 text-xs rounded-lg bg-white border border-gray-300 text-gray-600 hover:bg-gray-50 transition-all font-medium">
                    <i class="fa-regular fa-file-pdf mr-1"></i> Unduh
                  </button>
                </div>
              </div>
            </div>
              ...
              <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div>
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                    ...
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-calendar text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Tgl Selesai: <span class="font-medium text-gray-800">11 Feb 2026</span></span>
                    </div>
                  </div>
                </div>
                <div class="flex items-center gap-2">
        ...
        <div class="glass-card-deep rounded-xl p-5 border border-white/40 shadow-md history-card">
          <div class="flex flex-col lg:flex-row lg:items-center gap-4">
            ...
            <div class="flex items-center gap-3 lg:w-32">
              ...
              <div>
                <span class="font-bold text-gray-800 text-sm">Feb 2026</span>
                <p class="text-xs text-gray-500">13:00</p>
              </div>
            </div>
              ...
              <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div>
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                    ...
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-calendar text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Tanggal: <span class="font-medium text-gray-800">10 Feb 2026</span></span>
                    </div>
                  </div>
                </div>
                <div class="flex items-center gap-2">
        ...
        <!-- BULAN HEADER - JANUARI -->
        <div class="flex items-center gap-3 mt-6">
          <div class="w-2 h-8 bg-[#6FAED9] rounded-full"></div>
          <h3 class="font-bold text-[#17235b] text-lg">Januari 2026</h3>
          <span class="text-xs bg-[#6FAED9]/10 text-[#6FAED9] px-3 py-1.5 rounded-full font-medium">8 Riwayat</span>
        </div>
        ...
        <div class="glass-card-deep rounded-xl p-5 border border-white/40 shadow-md history-card">
          <div class="flex flex-col lg:flex-row lg:items-center gap-4">
            ...
            <!-- DATE -->
            <div class="flex items-center gap-3 lg:w-32">
              <div class="w-10 h-10 bg-gradient-to-br from-[#6FAED9] to-[#8EC7E0] rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-md">
                28
              </div>
              <div>
                <span class="font-bold text-gray-800 text-sm">Jan 2026</span>
                <p class="text-xs text-gray-500">09:00</p>
              </div>
            </div>
            ...
            <div class="flex-1">
              <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div>
                  <div class="flex items-center gap-2 mb-2">
                    <h4 class="font-bold text-gray-800 text-base">Konseling Sosial</h4>
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-user text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Siswa: <span class="font-medium text-gray-800">Anisa Putri</span></span>
                    </div>
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-building text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Kelas: <span class="font-medium text-gray-800">XI AKL 1</span></span>
                    </div>
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-user-tie text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Konselor: <span class="font-medium text-gray-800">Bu Denia</span></span>
                    ...
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-calendar text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Tanggal: <span class="font-medium text-gray-800">28 Jan 2026</span></span>
                    </div>
                  </div>
                </div>
                <div class="flex items-center gap-2">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 pt-4 border-t border-[#4F8DB8]/20">
        <div class="text-sm text-gray-500">
          Menampilkan <span class="font-medium text-[#4F8DB8]">1-4</span> dari <span class="font-medium text-[#4F8DB8]">156</span> riwayat
        </div>
        ...
        <div class="flex items-center gap-2">
          ...
          <button class="w-8 h-8 rounded-lg bg-white border border-gray-200 hover:bg-[#4F8DB8] hover:text-white hover:border-[#4F8DB8] transition-all flex items-center justify-center text-gray-700">16</button>
          <button class="w-8 h-8 rounded-lg bg-white border border-gray-200 hover:bg-[#4F8DB8] hover:text-white hover:border-[#4F8DB8] transition-all flex items-center justify-center text-gray-500">
            <i class="fa-solid fa-chevron-right text-xs"></i>
          </button>
        </div>
  ...
  <script>
    ...
    // AUTO EXPAND SISTEM KONSELING SUBMENU (karena halaman Riwayat Konseling)
