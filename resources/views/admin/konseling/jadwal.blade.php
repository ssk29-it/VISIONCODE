...
<body class="font-sans text-gray-700 overflow-x-hidden">
      ...
      <nav class="flex-1 overflow-y-auto py-5 space-y-1 text-sm">
        ...
        <div class="space-y-1">
          ...
          <div id="konselingMobile" class="ml-6 mt-1 space-y-1">
            ...
            <a href="jadwal.html" class="submenu-item flex items-center gap-3 px-4 py-2.5 rounded-xl bg-[#4F8DB8]/10 text-[#4F8DB8] font-medium pl-9">
    ...
    <main class="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6 relative z-10 lg:ml-0">
      ...
      <div class="glass-card-deep rounded-xl md:rounded-2xl p-3 md:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border border-white/40 shadow-xl">
        <div class="flex items-center gap-2 md:gap-3">
          ...
          <div>
            ...
            <p class="text-[10px] md:text-xs text-gray-500 flex items-center gap-1 md:gap-2">
              ...
              <span>Jadwal Konseling SMK Budi Bakti Ciwidey</span>
            </p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-2 text-xs text-gray-400 self-end sm:self-auto">
          ...
          <i class="fa-solid fa-chevron-right text-[10px]"></i>
          <span class="text-[#4F8DB8] font-medium">Jadwal Konseling</span>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          <div class="w-10 h-10 bg-[#4F8DB8]/10 rounded-lg flex items-center justify-center">
            <i class="fa-solid fa-calendar-day text-[#4F8DB8] text-lg"></i>
          </div>
          <div>
        ...
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xl font-bold text-[#17235b]">8</p>
          </div>
        </div>
        <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md flex items-center gap-3">
          <div class="w-10 h-10 bg-blue-500/10 rounded-lg flex items-center justify-center">
            <i class="fa-solid fa-calendar-plus text-blue-600 text-lg"></i>
          </div>
          <div>
            <p class="text-xs text-gray-500">Mendatang</p>
        ...
        <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <div class="relative flex-1 w-full">
            ...
            <div class="relative flex items-center gap-2 bg-white rounded-lg px-4 py-2.5 border border-white/50 shadow-sm">
              ...
              <input type="text" placeholder="Cari jadwal konseling..." class="w-full outline-none text-sm text-gray-700 placeholder-gray-400 bg-transparent" />
            </div>
          </div>
      ...
      <!-- DATE NAVIGATION -->
      <div class="glass-card-deep rounded-xl p-4 border border-white/40 shadow-md">
        <div class="flex items-center justify-between">
          <button class="w-8 h-8 rounded-lg bg-white border border-gray-200 hover:bg-[#4F8DB8] hover:text-white transition-all flex items-center justify-center">
            <i class="fa-solid fa-chevron-left text-xs"></i>
          </button>
          <div class="flex items-center gap-2">
            <span class="font-bold text-[#17235b]">Senin, 16 Februari 2026</span>
            <span class="text-xs bg-[#4F8DB8]/10 text-[#4F8DB8] px-3 py-1.5 rounded-full font-medium">Minggu Ini</span>
          </div>
          <button class="w-8 h-8 rounded-lg bg-white border border-gray-200 hover:bg-[#4F8DB8] hover:text-white transition-all flex items-center justify-center">
            <i class="fa-solid fa-chevron-right text-xs"></i>
          </button>
      ...
      <div class="space-y-4">
        ...
        <!-- DATE HEADER -->
        <div class="flex items-center gap-3">
          <div class="w-2 h-8 bg-[#4F8DB8] rounded-full"></div>
          <h3 class="font-bold text-[#17235b] text-lg">Hari Ini, 16 Februari 2026</h3>
          <span class="text-xs bg-emerald-100 text-emerald-700 px-3 py-1.5 rounded-full font-medium">5 Jadwal</span>
        </div>

        <!-- SCHEDULE CARD 1 -->
        <div class="glass-card-deep rounded-xl p-5 border border-white/40 shadow-md schedule-card">
          <div class="flex flex-col lg:flex-row lg:items-start gap-4">
            
            <!-- TIME -->
            <div class="flex items-center lg:flex-col lg:items-start gap-2 lg:gap-1 lg:w-24">
              <div class="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-[#4F8DB8] to-[#6FAED9] rounded-xl flex items-center justify-center text-white font-bold text-sm lg:text-base shadow-md">
                09:00
              </div>
              <span class="text-xs text-gray-500">60 menit</span>
            </div>
              ...
              <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div>
                  <div class="flex items-center gap-2 mb-2">
                    <h4 class="font-bold text-gray-800 text-base">Konseling Akademik</h4>
                    <span class="px-3 py-1.5 text-xs rounded-full bg-yellow-100 text-yellow-700 font-medium">Menunggu</span>
                  </div>
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-user text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Siswa: <span class="font-medium text-gray-800">Siska O.S</span></span>
                    </div>
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-building text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Kelas: <span class="font-medium text-gray-800">XI RPL 2</span></span>
                    </div>
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-user-tie text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Konselor: <span class="font-medium text-gray-800">Bu Denia</span></span>
                    </div>
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-location-dot text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Ruangan: <span class="font-medium text-gray-800">Ruang BK Lt.2</span></span>
                    </div>
                  </div>
                </div>
                <div class="flex items-center gap-2">
                  <button class="px-4 py-2 text-xs rounded-lg bg-gradient-to-r from-[#4F8DB8] to-[#6FAED9] text-white hover:shadow-md transition-all font-medium">
                    <i class="fa-regular fa-eye mr-1"></i> Detail
                  </button>
                  <button class="px-4 py-2 text-xs rounded-lg bg-white border border-green-500 text-green-600 hover:bg-green-50 transition-all font-medium">
                    <i class="fa-regular fa-circle-check mr-1"></i> Setujui
                  </button>
                </div>
              </div>
            </div>
        ...
        <div class="glass-card-deep rounded-xl p-5 border border-white/40 shadow-md schedule-card">
          <div class="flex flex-col lg:flex-row lg:items-start gap-4">
            ...
            <div class="flex items-center lg:flex-col lg:items-start gap-2 lg:gap-1 lg:w-24">
              ...
              <span class="text-xs text-gray-500">45 menit</span>
            </div>
            ...
            <div class="flex-1">
              <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div>
                  <div class="flex items-center gap-2 mb-2">
                    <h4 class="font-bold text-gray-800 text-base">Konseling Pribadi</h4>
                    <span class="px-3 py-1.5 text-xs rounded-full bg-green-100 text-green-700 font-medium">Disetujui</span>
                  </div>
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-user text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Siswa: <span class="font-medium text-gray-800">Muthy Chairunnisa</span></span>
                    </div>
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-building text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Kelas: <span class="font-medium text-gray-800">XI RPL 2</span></span>
                    ...
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-user-tie text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Konselor: <span class="font-medium text-gray-800">Pak Ahmad</span></span>
                    </div>
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-video text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Link: <span class="font-medium text-gray-800">Zoom Meeting</span></span>
                    </div>
                  </div>
                </div>
                <div class="flex items-center gap-2">
                  ...
                  <button class="px-4 py-2 text-xs rounded-lg bg-white border border-blue-500 text-blue-600 hover:bg-blue-50 transition-all font-medium">
                    <i class="fa-regular fa-pen-to-square mr-1"></i> Ubah
                  </button>
                </div>
              </div>
            </div>
          ...
          <div class="flex flex-col lg:flex-row lg:items-start gap-4">
            ...
            <div class="flex-1">
              <div class="flex flex-col md:flex-row md:items-center justify-between gap-3">
                <div>
                  <div class="flex items-center gap-2 mb-2">
                    <h4 class="font-bold text-gray-800 text-base">Konseling Karir</h4>
                    <span class="px-3 py-1.5 text-xs rounded-full bg-blue-100 text-blue-700 font-medium">Online</span>
                  </div>
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-user text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Siswa: <span class="font-medium text-gray-800">Revan Nurfalah</span></span>
                    </div>
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-building text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Kelas: <span class="font-medium text-gray-800">XII RPL 2</span></span>
                    </div>
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-user-tie text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Konselor: <span class="font-medium text-gray-800">Bu Rina</span></span>
                    </div>
                    <div class="flex items-center gap-2">
                      <i class="fa-regular fa-video text-[#4F8DB8] text-xs"></i>
                      <span class="text-gray-600">Link: <span class="font-medium text-gray-800">Google Meet</span></span>
                    </div>
                  </div>
                </div>
                <div class="flex items-center gap-2">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 pt-4 border-t border-[#4F8DB8]/20">
        <div class="text-sm text-gray-500">
          Menampilkan <span class="font-medium text-[#4F8DB8]">1-3</span> dari <span class="font-medium text-[#4F8DB8]">24</span> jadwal
        </div>
  ...
  <script>
    ...
    // AUTO EXPAND SISTEM KONSELING SUBMENU (karena halaman Jadwal Konseling)
